...
int main()
{
	// float *TwoDimArray[NUMROWS];   // caution - this array is uninitialized, so the following declaration is preferred
	float* TwoDimArray[NUMROWS] =
		{ nullptr, nullptr, nullptr, nullptr, nullptr };   // alternatively, initialize each element to nullptr
	int numColumns = 0;
	...
	// (the []'s ensure a cleanup fn is called on each element -- useful for user defined types)
