...
int main()
{
	...
	delete &id2;   // It is very unusual we'd delete in this fashion, but now you know, that you can take the
	// address of a ref variable. Also, allocating and deleting in diff scopes can lead to errors.
	// This will motivate the use of smart pointers later.
	return 0;
}
